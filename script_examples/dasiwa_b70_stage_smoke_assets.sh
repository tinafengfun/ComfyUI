...
echo "==> Staging B70 workflow assets into ${MODEL_ROOT}"
link_if_exists "${SHARED_MODEL_ROOT}/text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors" "${MODEL_ROOT}/text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors"
...
link_if_exists "${SHARED_MODEL_ROOT}/vae/wan_2.1_vae.safetensors" "${MODEL_ROOT}/vae/wan_2.1_vae.safetensors"
